                        ...
                        <table id="req_form">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type='text' name='facility' placeholder="Credit">
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type='text' name='currency' placeholder="GHC">
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type='text' name='rate_to_usd' placeholder="2.0">
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type='text' name='value_date' placeholder="">
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type='text' name='donors_ref' placeholder="">
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type='text' name='external_commit' placeholder="">
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type='text' name='local_commit' placeholder="">
                                    </td>
