                        ...
                        <table id="req_form">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type='text' name='date_of_tender_opening' placeholder="">
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type='text' name='date_of_contract_award' placeholder="">
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type='text' name='date_of_signing_agreement' placeholder="">
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type='text' name='date_of_commencement' placeholder="">
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type='text' name='date_of_contract_completion' placeholder="">
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type='text' name='date_of_defects_liability' placeholder="">
                                    </td>
